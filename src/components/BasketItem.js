      ...
      <div className="d-flex flex-wrap">
          <div className="d-flex flex-wrap">
              ...
              <div className="d-flex flex-column align-items-start">
                  <div style={{color: '#323540', fontSize: 18}}>{item.name}</div>
                  <div className="d-flex align-items-end">
                      <div style={{color: '#616575', fontSize: 12}}>Размер:</div>
                      <div style={{width: 8}}/>
                      <div style={{color: '#515562', fontSize: 14}}>{item.size}</div>
                  </div>
                  ...
                  <div className="d-flex">
                      <div className="d-flex flex-column">
                          ...
                          <div style={{background: '#FFF', border: '0.5px solid #CDCFD6'}}>
                              <div className="d-flex block_quantity justify-content-around">
                                  ...
                                  <div style={{color: '#515562', fontSize: '14'}}>{item.quantity}</div>
                      ...
                      <div className="d-flex flex-column">
                          ...
                          <div style={{color: '#515562', fontSize: 14}}>{item.sum} {SYMBOL_RUBLE}</div>
                      </div>
                  </div>
              </div>
          </div>
